    ...
    try {
      ...
      const enriched = rows.map((row) => {
        ...
        return {
          ...
          db_client: db.client_name ?? "",
          db_phone_1: db.phone_1 ?? "",
          db_phone_2: db.phone_2 ?? "",
          db_phone_3: db.phone_3 ?? "",
          db_email_1: db.email_1 ?? "",
          db_email_2: db.email_2 ?? "",
          db_email_3: db.email_3 ?? "",
          db_wrong_1: String(db.wrong_1 ?? false),
          db_wrong_2: String(db.wrong_2 ?? false),
          db_wrong_3: String(db.wrong_3 ?? false),
          db_mailing_address: db.mailing_address ?? "",
          db_mailing_city: db.mailing_city ?? "",
          db_mailing_state: db.mailing_state ?? "",
          db_mailing_zip: db.mailing_zip ?? "",
        };
      });
